...
│  │  │   - Listings         │   │◄───────┼──┤   (See Contracts and CRE)        │   ││
│  │  │   - Session Requests │   │        │  └────────────────────────────────┘   ││
│  │  └──────────────────────┘   │        │  ┌────────────────────────────────┐   ││
│  │         │                    │        │  │   Settlement Workflow          │   ││
│  │         ▼                    │        │  │   (See Contracts and CRE)      │   ││
│  │  ┌──────────────────────┐   │        │  └────────────────────────────────┘   ││
│  │  │ KXSessionRegistry    │   │        │                                      ││
│  │  │   - Escrow           │   │        │                                      ││
│  │  │   - AI Evaluation    │   │        │                                      ││
...
└─────────────┘                             └─────────────┘
       ...
       │    Recall bot joins
       ▼
[From here, CRE workflows take over — see Contracts and CRE]
       │
       ▼
┌─────────────┐
...
└──────┬──────┘
       │
       ▼
[Contracts settle payment — see Contracts and CRE]
       │
       ▼
┌─────────────┐     12. Claim funds        ┌─────────────┐
│   Teacher   │◄───────────────────────────│   Learner   │
